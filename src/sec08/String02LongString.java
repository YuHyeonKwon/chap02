...
public class String02LongString { // class s
...
//		}
		...
		// 향상된 for 문
		for ( String story : str1) {
			System.out.println(story);
		}
		
		// 문제1. 위에 str 데이터 중 "HTML5"라는 단어가 몇번나오는지 count 하시오.
		// 노출 횟수를 resultNum 이라는 배열명으로 저장하여 출력
...
//		for(int i = arrStr.length-1; i>= 0; i--) {	// 인덱스는 0부터시작해서 -1 해줌
